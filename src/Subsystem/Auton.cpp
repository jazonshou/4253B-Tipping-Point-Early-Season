...
void Auton::wingGrab() {
    ...
    wings.setState(true); pros::delay(250); wings.setState(false); pros::delay(250);
}
...
void Auton::right(){
    ...
    pros::delay(250);
    mogoClamp.setState(true); pros::delay(250); mogo.setState(true);
...
void Auton::skills(){
    ...
    mogo.setState(false); pros::delay(250); mogoClamp.setState(false);
    ...
    mogoClamp.setState(true); pros::delay(500); mogo.setState(true);
